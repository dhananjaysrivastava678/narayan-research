...
const archiveArticles = [
  {
    id: 1,
    title: " New Trends in Political Leadership and Dominant Patterns in Sri Lanka",
    authors: "Jagath Wellawatte",
    volume: "1",
    issue: "1",
    year: "2026",
    pages: "1 - 12",
    type: "Research Article",
    pdf: "/assets/articles/SIJARS{ 1 } { 1 } 1-12.pdf",
  },

  {
    id: 2,
    title: "Gamification in Modern Education",
    authors: "Anand Dwived",
    volume: "1",
    issue: "1",
    year: "2026",
    pages: "13 - 19",
    type: "Research Article",
    pdf: "/assets/articles/SIJARS { 1 } { 1 } 13-19.pdf",
  },

  {
    id: 3,
    title: "Exchange Rates and Economic Growth",
    authors: "Dr. Rakesh Paswan ",
    volume: "1",
    issue: "1",
    year: "2026",
    pages: "20 - 27",
    type: "Research Article",
    pdf: "/assets/articles/SIJARS { 1 } { 1 } 20-27.pdf",
  },
    {
    id: 4,
    title: "The Nutritional Legacy of the Green Revolution",
    authors: "Dr. Nagmanee Kumar",
    volume: "1",
    issue: "1",
    year: "2026",
    pages: "28-36",
    type: "Research Article",
    pdf: "/assets/articles/SIJARS { 1 } { 1 } 28-36.pdf",
  },
    {
    id: 5,
    title: "Sardar Patel's Vision for Indian Civil Services",
    authors: "Dr. Neha Sharma ",
    volume: "1",
    issue: "1",
    year: "2026",
    pages: "37 - 48",
    type: "Research Article",
    pdf: "/assets/articles/SIJARS { 1 } { 1 }  37-48.pdf",
  },
];
      ...
      <div className="grid gap-6">
        ...
        {archiveArticles.map((article) => (
          ...
          >
            ...
            <p className="mb-2">
              <strong>Author(s):</strong> {article.authors}
            </p>
            ...
            <p className="mb-2">
              <strong>Article Type:</strong> {article.type}
            </p>
